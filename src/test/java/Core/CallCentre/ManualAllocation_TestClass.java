...
public class ManualAllocation_TestClass {
	...
	public void Login_to_call_centre_application_and_take_account_filtration_page() throws InterruptedException {
		...
		try {
			...
			Assert.assertTrue(currentUrl.contains("CallCentre/CallCentreLeadFiltration"),
					"Not navigated to Account Filtration page.");
			ExtentTestManager.getTest().log(Status.PASS,
					"User is navigated to Account Filtration page, URL shows CallCentre/CallCentreLeadFiltration.");
	...
	public void Allocated_To_dropdown_mandatory_checking() throws InterruptedException {
		...
		try {
			...
			Assert.assertEquals(coremanualallocationpage.getWarningMessage(), expectedMessage,
					"Warning message not displayed as expected");
	...
	public void Asset_category_dropdown_mandatory_checking(Map<Object, Object> testdata) throws InterruptedException {
		...
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Left the Asset Category field empty and selected a value in the Allocated To field.");
			}
			// Click Search button
			coremanualallocationpage.clickSearchButtonaftergivingvalueforallocatedto();
			ExtentTestManager.getTest().log(Status.PASS, "Clicked on the Search button.");
			// Verify the warning message
			Assert.assertEquals(coremanualallocationpage.getWarningMessageaftergivingvalueforallocatedto(),
	...
	public void NPA_Category_Selection_() throws InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Selected sub-standard, doubtful-1, doubtful-2, doubtful-3, and loss asset.");
			ExtentTestManager.getTest().log(Status.PASS,
					"Selected NPA categories sub-standard , doubtful-1 , doubtful-2,doubtful-3,loss asset should be selected from the dropdown");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void Perform_Search_with_Valid_Data() throws Throwable {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Ensured that the Asset Category, SMA Category, NPA Category, and Allocated To mandatory fields are filled.");
			...
			if (gridText.contains("No records to display.")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Verified that the grid displays the message \"No records to display\" when no data is available.");
			} else {
				System.out.println("Total accounts allocated");
				Assert.fail(
						"Test failed because grid text did not contain 'No records to display'. Instead, it contains: records");
			}
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
...
//	
	...
	public void Login_and_Navigation_to_Manual_Allocation() throws Exception {
		try {
			...
			Assert.assertTrue(coremanualallocationpage.isManualAllocationPageLoaded(),
					"Manual Allocation page not loaded correctly.");
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Manual Allocation page is displayed with URL ending in `CallCentre/ManualAllocationConfiguration`");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void Mandatory_Field_Validation_for_Asset_Category() throws InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"After leaving the Asset Category and To fields blank and clicking the search button, a warning message 'Asset category is Required' appeared.");
	...
	public void Asset_Category_SMA_and_NPA_Selection() throws InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Selected 'NPA' and 'SMA' category from the Asset Category dropdown.");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void OS_Balance_Field_Validation(Map<Object, Object> testdata) throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Selected '=' from the 'Select Financial Operator' dropdown, and entered '1234' in the O/S Balance field.");
			}
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
	...
	public void Search_with_Mandatory_Fields() throws InterruptedException {
		try {
			...
			WebElement totalAccountSelected = driver.findElement(CoreManualAllocationRepo.TotalAccountSelected); // Update
																													// with
																													// the
																													// actual
																													// locator
			WebElement totalOutstandingAmount = driver.findElement(CoreManualAllocationRepo.TotalOutStandingAmount); // Update
																														// with
																														// the
																														// actual
																														// locator
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"The accounts count is displayed with the columns 'Total Account Selected' and 'Total Outstanding Amount'.");
	...
	public void Excel_Account_Count_Verification() throws IOException, InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Verified that the account count in the Excel file matches the account count displayed in the grid.");
			ExtentTestManager.getTest().log(Status.PASS,
					"The account count matches in both the grid and the downloaded Excel file.");
	...
	public void Login_to_call_centre_application_and_take_updation_of_disposition_page() throws Exception {
		...
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"After entering the account number in the search tab and clicking the search button, the warning message 'You are not authorized to do the disposition of this account number' appeared.");
		}
	...
	public void Login_and_Navigation_to_Manual_Allocation_Core_Application() throws Exception {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS, "Clicked on the Manual Allocation submenu successfully.");
			ExtentTestManager.getTest().log(Status.PASS,
					"The Manual Allocation page is displayed with the URL 'CallCentre/ManualAllocationConfiguration'.");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void Mandatory_Field_Validation_for_Asset_Category_() throws InterruptedException {
		try {
			...
			Assert.assertEquals(warning, "Asset Category Required");
			ExtentTestManager.getTest().log(Status.PASS,
					"After not entering values for the Asset Category and To fields and clicking the search button, the warning message 'Asset category is Required' appeared.");
			wait.until(ExpectedConditions.invisibilityOfElementLocated(CoreManualAllocationRepo.warningMessage));
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
	...
	public void Asset_Category_SMA_and_NPA_Selection_() throws InterruptedException {
		try {
			...
			coremanualallocationpage.selectAssetCategory();
			ExtentTestManager.getTest().log(Status.PASS,
					"Selected 'NPA' category from the Asset Category dropdown and 'SMA' category from the dropdown.");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void NPA_Category_Dropdown_Selection_() throws InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"After selecting values from the NPA category dropdown and clicking the search button, the warning message 'To is Required' appeared.");
			wait.until(ExpectedConditions
					.invisibilityOfElementLocated(CoreManualAllocationRepo.Tofieldmandatorywarningmsg));
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void Allocate_to_Field_Dropdown_Selection(Map<Object, Object> testdata) throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Successfully selected 'Call Centre' from the 'Allocate To' dropdown.");
			}
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
	...
	public void Select_Call_Centre_Field_Dropdown_Selection(Map<Object, Object> testdata) throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Successfully selected 'CallCentre 1' from the 'Select Call Centre' dropdown.");
			}
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
	...
	public void Assign_Button_Validation_Message() throws InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Validation message 'Assigned successfully' appears after allocation.");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void Verify_Mandatory_Fields() throws InterruptedException {
		try {
			...
			Assert.assertTrue(coremanualallocationpage.isAssetCategoryMandatory(),
					"'Asset Category' field should be mandatory");
			ExtentTestManager.getTest().log(Status.PASS,
					"Checked if the 'Asset Category' dropdown is marked mandatory.");
			// Test to confirm that the 'Allocated To' field is marked as mandatory
			Assert.assertTrue(coremanualallocationpage.isAllocatedToMandatory(),
					"'Allocated To' field should be mandatory");
			ExtentTestManager.getTest().log(Status.PASS, "Checked if the 'Allocated To' field is marked mandatory.");
			ExtentTestManager.getTest().log(Status.PASS,
					"Both 'Asset Category' and 'Allocated To' fields are marked as mandatory.");
		}
	...
	public void Allocated_To_Selection_Call_Centre(Map<Object, Object> testdata) throws InterruptedException {
		...
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Successfully selected 'Call Centre' from the 'Allocated To' dropdown.");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void Verify_Downloaded_File() throws InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Data match successful: Expected data matches the actual data.");
		} catch (AssertionError | Exception e) {
			ExtentTestManager.getTest().log(Status.FAIL, "Test Failed: " + e.getMessage());
			throw e;
		}
	...
	public void Verify_the_URL_after_navigating_to_the_Updation_of_Disposition_page() throws Exception {
		...
		try {
			...
			String currentUrl = driver.getCurrentUrl();
			Assert.assertTrue(currentUrl.contains("CallCentre/DispositionByAgent"),
					"Not navigated to Account Filtration page.");
	...
	@Test(priority = 44)
	public void Validate_presence_of_fields_and_buttons_on_the_Updation_of_Disposition_page()
			throws InterruptedException {
		try {
			Assert.assertTrue(coremanualallocationpage.isAccountNumberFieldPresent(),
			...
			Assert.assertTrue(coremanualallocationpage.isCheckLiveBalanceButtonPresent(),
					"Check live balance button is missing");
			ExtentTestManager.getTest().log(Status.PASS, "Checked for the \"Check Live Balance\" button.");
			Assert.assertTrue(coremanualallocationpage.isTransactionDetailsSectionPresent(),
					"Transaction details button is missing");
	...
	public void Account_Number_Field_ECP_Validations(Map<Object, Object> testdata) throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				Assert.assertTrue(coremanualallocationpage.isAccountNumberFieldValid(Alphabets),
						"Alphabets are incorrectly allowed");
				ExtentTestManager.getTest().log(Status.PASS,
						"Tested the \"Account Number\" field with alphabetic and input got restricted");
				// Test with Numeric input
				coremanualallocationpage.enterAccountNumbers(Numeric);
				Assert.assertTrue(coremanualallocationpage.isAccountNumberFieldValid(Numeric),
						"Numeric inputs are not allowed");
				ExtentTestManager.getTest().log(Status.PASS,
						"Tested the \\\"Account Number\\\" field with numeric and inputs are allowed");
				// Test with Alphanumeric input
				coremanualallocationpage.enterAccountNumbers(Alphanumeric);
				Assert.assertTrue(coremanualallocationpage.isAccountNumberFieldValid(Alphanumeric),
						"Alphanumeric incorrectly allowed");
				ExtentTestManager.getTest().log(Status.PASS,
						"Tested the \\\"Account Number\\\" field with alphanumeric  and input got restricted");
			}
		}
	...
	public void Search_with_Invalid_Account_Number() throws InterruptedException {
		try {
			...
			coremanualallocationpage.clickSearchButon();
			ExtentTestManager.getTest().log(Status.PASS,
					"Entered an invalid account number in the \"Account Number\" field.");
			ExtentTestManager.getTest().log(Status.PASS, "Clicked on the \"Search\" button.");
			...
			wait.until(ExpectedConditions
					.invisibilityOfElementLocated(CoreManualAllocationRepo.validationMessageforinvalidaccountnumber));
		}
	...
	public void Search_with_Valid_Account_Number() throws InterruptedException {
		try {
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Entered the valid account number in the \"Account Number\" field");
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Verified that the account details were displayed along with the \"Add Interaction Details\" field");
		}
	...
	public void Verify_Fields_in_Add_Interaction_Details_Section() throws InterruptedException {
		try {
			...
			Assert.assertTrue(coremanualallocationpage.areAllFieldsPresent(),
					"Not all fields are present in the Add Interaction Details section.");
			ExtentTestManager.getTest().log(Status.PASS,
					"Checked for the presence of the \"Action Owner,\" \"Disposition Type,\" \"Sub Disposition,\" \"Next Action Date,\" \"Remark,\" \"Save,\" and \"Cancel\" buttons.");
		}
	...
	public void Select_Internal_User_from_Action_Owner_Dropdown(Map<Object, Object> testdata)
			throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Selected " + value + " from the \"Action Owner\" dropdown.");
			}
		}
	...
	public void Select_Disposition_Type(Map<Object, Object> testdata) throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Selected " + value + " from the \"Disposition Type\" dropdown.");
			}
		}
	...
	public void Select_Sub_Disposition(Map<Object, Object> testdata) throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Selected " + value + " from the \"Sub Disposition\" dropdown");
			}
		}
	...
	public void Select_Date_in_Next_Action_Date_DatePicker(Map<Object, Object> testdata) throws InterruptedException {
		try {
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				ExtentTestManager.getTest().log(Status.PASS,
						"Selected " + value + " using the \"Next Action Date\" date picker.");
			}
		}
	...
	public void Enter_Remarks_and_Save_Interaction(Map<Object, Object> testdata) throws InterruptedException {
		try {
			...
			Assert.assertEquals(actualMessage, expectedMessage, "Validation message mismatch");
			ExtentTestManager.getTest().log(Status.PASS,
					"Verified that the success message \"Saved Successfully\" was displayed.");
			wait.until(ExpectedConditions
					.invisibilityOfElementLocated(CoreManualAllocationRepo.validationMessageforInteractionDetails));
		}
	...
	public void Search_for_Previously_Saved_Account_Interaction_Details() throws InterruptedException {
		try {
			...
			coremanualallocationpage.enterAccountNumbers(accountNumber);
			ExtentTestManager.getTest().log(Status.PASS,
					"Entered the same account number " + accountNumber + " in the \"Account Number\" field.");
			// Click on search button
			coremanualallocationpage.clickSearchButon();
			ExtentTestManager.getTest().log(Status.PASS, "Clicked on the \"Search\" button.");
			...
			ExtentTestManager.getTest().log(Status.PASS,
					"Verified that the saved interaction details were displayed under \"History of Interaction Details.\"");
		}
