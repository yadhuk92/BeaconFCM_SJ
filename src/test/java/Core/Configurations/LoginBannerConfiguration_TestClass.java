...
import Core.Configurations.LoginBannerConfiguration_MainClass;
 

public class LoginBannerConfiguration_TestClass extends Base_Class{
		...
		LoginBannerConfiguration_TestClass configurationPage;
		LoginBannerConfiguration_MainClass loginbanner;
		LoginBannerConfiguratonPageRepo PageRepository;
		...
		public void reference() throws Exception {
			...
			loginbanner= new LoginBannerConfiguration_MainClass(driver);
			PageRepository= new LoginBannerConfiguratonPageRepo();
		}
