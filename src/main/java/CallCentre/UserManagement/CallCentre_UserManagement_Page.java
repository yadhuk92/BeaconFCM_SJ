...
public class CallCentre_UserManagement_Page extends Base_Class {
	...
	public boolean GoCollectionModule() throws InterruptedException {
		...
		Common.fluentWait("GoCollection", CallCentre_Locators.GoCollection);
		Thread.sleep(5000);
		click(CallCentre_Locators.GoCollection);
		Thread.sleep(1000);
		return true;
	}
	...
	public boolean SelectSecurityManagementMenu() throws InterruptedException {
		...
		// Common.waitForSpinnerToDisappear("Loading Spinner",
		// CallCentre_Locators.UserMgmtSpinner);
		Common.fluentWait("SecurityManagementMenu", CallCentre_Locators.SecurityManagementMenu);
		// PageRepository.SecurityManagementMenu);
		click(CallCentre_Locators.SecurityManagementMenu);
		return true;
	}

	public boolean SelectUserManagementMenu() throws InterruptedException {
//		Common.waitForSpinnerToDisappear("Loading Spinner", CallCentre_Locators.UserMgmtSpinner);
		Common.fluentWait("UserManagementMenu", CallCentre_Locators.UserManagementMenu);
		click(CallCentre_Locators.UserManagementMenu);
		// Common.waitForSpinnerToDisappear("Loading Spinner",
		// PageRepository.moduleSelectionSpinner);
		return true;
	}
	...
	public boolean LocatorDisplayed() throws InterruptedException {
		...
		Thread.sleep(2000);
		// Common.waitForSpinnerToDisappear("Loading Spinner",
		// CallCentre_Locators.AddUserMgmtSpinner);
		// Common.waitForSpinnerToDisappear("Loading Spinner",
		// PageRepository.UserManagementSpinner);
		waitVisibility(CallCentre_Locators.UserManagementPageUsername);

		ElementDisplayed(CallCentre_Locators.UserManagementExecutiveID);
		ElementDisplayed(CallCentre_Locators.UserManagementPageUsername);
		ElementDisplayed(CallCentre_Locators.UserManagementPageName);
		ElementDisplayed(CallCentre_Locators.UserManagementPageMobilenumber);
		ElementDisplayed(CallCentre_Locators.UserManagementPageEmailId);
		ElementDisplayed(CallCentre_Locators.UserManagementPageRole);
		ElementDisplayed(CallCentre_Locators.UserManagementPageIsActive);
		ElementDisplayed(CallCentre_Locators.UserManagementPageSearch);
		ElementDisplayed(CallCentre_Locators.UserManagementPageAddUser);
		ElementDisplayed(CallCentre_Locators.UserManagementPageGrid);
		return true;
	}
...
//	}
	...
	public boolean UsernameInput(String username) throws InterruptedException {
		input(CallCentre_Locators.UserManagementPageUsername, username);

		return true;
	}

	public boolean UserManagementSearchBtn() throws InterruptedException {
		click(CallCentre_Locators.UserManagementPageSearch);
	 ...
	 * driver.findElement(CallCentre_Locators.UserManagementPageIsActive).
	...
	public boolean ClickUserManagementPageAddUserBtn() throws InterruptedException {
		...
		// CallCentre_Locators.UserManagementPageAddUser);
		// Common.waitForSpinnerToDisappear("Loading Spinner",
		// PageRepository.UserMgmtSpinner);
		// Common.waitForSpinnerToDisappear("Loading Spinner",
		// PageRepository.AddUserSpinner);
//		Common.fluentWait("UserManagementPageAddUser", PageRepository.UserManagementPageAddUser);
		click(CallCentre_Locators.UserManagementPageAddUser);
	...
	public boolean AddNewUserPageElementsDisplayed() throws InterruptedException {
		...
		ElementDisplayed(CallCentre_Locators.AddNewUserSubmitBtn);
...
//			Common.waitForSpinnerToDisappear("Loading Spinner", PageRepository.AddUserSpinner);
			input(CallCentre_Locators.UserManagementaddExecutiveID, ExecutiveID);
	...
	public boolean EnterAddNewUserNameDup(String NameDup) throws InterruptedException {
		try {
			input(PageRepository.AddNewUserNameBtn, NameDup);
			return true;
		} catch (Exception e) {
			System.out.println("Error: " + e);
			return false;
...
//	
	...
	public boolean EnterAddNewUserEmailDup(String EmailDup) throws InterruptedException {
		try {
			input(PageRepository.AddNewUserEmailBtn, EmailDup);
			return true;
		} catch (Exception e) {
			System.out.println("Error: " + e);
			return false;
	...
	public boolean EnterAddNewUserPhoneNumberDup(String PhoneDup) throws InterruptedException {
		try {
			input(PageRepository.AddNewUserPhoneNumberBtn, PhoneDup);
			return true;
		} catch (Exception e) {
			System.out.println("Error: " + e);
			return false;
	...
	public boolean EnterAddNewUserPhoneNumberInvalid(String InvalidPhone) throws InterruptedException {
		try {
			WebElement executiveIdField = driver.findElement(CallCentre_Locators.UserManagementaddExecutiveID);
			executiveIdField.clear();
			WebElement nameField = driver.findElement(PageRepository.AddNewUserNameBtn);
			...
			emailField.clear();
			input(PageRepository.AddNewUserPhoneNumberBtn, InvalidPhone);
			return true;
		} catch (Exception e) {
			System.out.println("Error: " + e);
			return false;
...
//			Common.fluentWait("NewUserRoleType", PageRepository.NewUserRoleType);
	...
	public void SelectRole(WebDriver driver) throws InterruptedException {
		try {
			Common.fluentWait("NewUserRoleType", PageRepository.NewUserRoleType);
			click(PageRepository.NewUserRoleType);
			Common.fluentWait("RoleDropdownValues", PageRepository.RoleDropdownValues);
			List<WebElement> dropdownValues = driver.findElements(PageRepository.RoleDropdownValues);
			for (WebElement values : dropdownValues) {
				if (values.getText().equals("CallCentreRole")) {
					values.click();
	...
	public boolean isUserPresentInGrid(String value, WebDriver driver) throws InterruptedException {
		Common.waitForSpinnerToDisappear("Loading Spinner", CallCentre_Locators.AddUserMgmtSpinner);
...
// Print the extracted username and password
	...
	public void ECPValidationExecutiveID(WebDriver driver) throws InterruptedException {
		try {
			WebElement nameField = driver.findElement(PageRepository.AddNewUserNameBtn);
			nameField.clear();
			nameField.sendKeys("John Seb");

			WebElement emailField = driver.findElement(PageRepository.AddNewUserEmailBtn);
			emailField.clear();
			emailField.sendKeys("johndore@gmail.com");

			WebElement phoneField = driver.findElement(PageRepository.AddNewUserPhoneNumberBtn);
			phoneField.clear();
			phoneField.sendKeys("5534567590");
...
//					.findElement(By.xpath("//label[text()='Phone Number']/following-sibling::div"));
			...
			executiveIdField.clear();
			Thread.sleep(3000);
			executiveIdField.sendKeys("6355111");
			click(PageRepository.UserManagementAddSpace);
			ExtentTestManager.getTest().log(Status.PASS,
	...
	public void ECPValidationName(WebDriver driver) throws InterruptedException {
		try {
//			Common.waitForSpinnerToDisappear("Loading Spinner", PageRepository.AddUserMgmtSpinner);
			WebElement executiveIdField = driver.findElement(CallCentre_Locators.UserManagementaddExecutiveID);
			executiveIdField.clear();
			executiveIdField.sendKeys("444433");
			...
			WebElement emailField = driver.findElement(PageRepository.AddNewUserEmailBtn);
			emailField.clear();
			emailField.sendKeys("johndtr45545@example.com");

			WebElement phoneField = driver.findElement(PageRepository.AddNewUserPhoneNumberBtn);
			phoneField.clear();
			phoneField.sendKeys("2229660807");
			Thread.sleep(3000);
		} catch (Exception e) {
			System.out.println("Error: " + e);
		}
	...
	public void ECPValidationEmail(WebDriver driver) throws InterruptedException {
		try {
			WebElement executiveIdField = driver.findElement(CallCentre_Locators.UserManagementaddExecutiveID);
			executiveIdField.clear();
			executiveIdField.sendKeys("22221");

			WebElement nameField = driver.findElement(PageRepository.AddNewUserNameBtn);
			nameField.clear();
			nameField.sendKeys("New Toyy");

			WebElement emailField = driver.findElement(PageRepository.AddNewUserEmailBtn);
			Common.fluentWait("AddNewUserEmailBtn", PageRepository.AddNewUserEmailBtn);
			emailField.clear();
			emailField.sendKeys("john444ttttoe@example.com");
			click(PageRepository.UserManagementAddSpace);
			Thread.sleep(3000);
			ExtentTestManager.getTest().log(Status.PASS,
					"1.1 Alphabetic input, the system accepts the input on the Email ID field");
			emailField.clear();
			emailField.sendKeys("facer5656@example.com");
			click(PageRepository.UserManagementAddSpace);
			Thread.sleep(3000);
			ExtentTestManager.getTest().log(Status.PASS,
					"1.2 Numeric input, the system accepts the input on the Email ID field");
			emailField.clear();
			emailField.sendKeys("johnd6ttt655@example.com");
			click(PageRepository.UserManagementAddSpace);
			Thread.sleep(3000);
			ExtentTestManager.getTest().log(Status.PASS,
					"1.3 Alphanumeric input, the system accepts the input on the Email ID field");

			WebElement phoneField = driver.findElement(PageRepository.AddNewUserPhoneNumberBtn);
			phoneField.clear();
			phoneField.sendKeys("7033399776");
			Thread.sleep(3000);
		} catch (Exception e) {
			System.out.println("Error: " + e);
		}
	...
	public void ECPValidationPhone(WebDriver driver) throws InterruptedException {
		try {
			WebElement executiveIdField = driver.findElement(CallCentre_Locators.UserManagementaddExecutiveID);
			executiveIdField.clear();
			executiveIdField.sendKeys("3997761");

			WebElement nameField = driver.findElement(PageRepository.AddNewUserNameBtn);
			nameField.clear();
			nameField.sendKeys("New Rntt");

			WebElement emailField = driver.findElement(PageRepository.AddNewUserEmailBtn);
			emailField.clear();
			emailField.sendKeys("johnggttfft55oe@example.com");

			WebElement phoneField = driver.findElement(PageRepository.AddNewUserPhoneNumberBtn);
			Common.fluentWait("AddNewUserPhoneNumberBtn", PageRepository.AddNewUserPhoneNumberBtn);
			phoneField.clear();
			phoneField.sendKeys("123455AAAA");
			click(PageRepository.UserManagementAddSpace);
			Thread.sleep(3000);
			ExtentTestManager.getTest().log(Status.PASS,
					"1.1 Alphanumeric input, the system throws an error message on the Phone Number field");
			phoneField.clear();
			phoneField.sendKeys("RRRYYYAAAA");
			click(PageRepository.UserManagementAddSpace);
			Thread.sleep(3000);
			ExtentTestManager.getTest().log(Status.PASS,
					"1.2 Alphabetic input, the system throws an error message  on the Phone Number field");
			phoneField.clear();
			phoneField.sendKeys("6485127666");
			click(PageRepository.UserManagementAddSpace);
			Thread.sleep(3000);
			ExtentTestManager.getTest().log(Status.PASS,
					"1.3 Numeric input, the system accepts the input on the Phone Number field");
		} catch (Exception e) {
			System.out.println("Error: " + e);
		}
	}
...
//		Common.waitForSpinnerToDisappear("Loading Spinner", PageRepository.AddUserSpinner);
	...
	public boolean ClickAddNewUserSubmitBtnECP() throws InterruptedException {
//		Common.waitForSpinnerToDisappear("Loading Spinner", PageRepository.AddUserSpinner);
		Common.fluentWait("AddNewUserSubmitBtn", CallCentre_Locators.AddNewUserSubmitBtn);
		click(CallCentre_Locators.AddNewUserSubmitBtn);
		Common.fluentWait("PwdText", PageRepository.PwdText);
...
//    }
	...
	public boolean ModuleSelectionEltDisplayed() throws InterruptedException {
		...
		ElementDisplayed(CallCentre_Locators.GoCollection);
	...
	public boolean SelectUserManagementPageRole(String value) throws InterruptedException {
		SelectActiveDropdown(CallCentre_Locators.UserManagementPageRole, value);
		return true;
	}
	...
	public boolean EnterUsernameInUNPage(String UN) throws InterruptedException {
		input(CallCentre_Locators.UserManagementPageUsername, UN);
		return true;
	}

	public boolean ClearUsernameInUNPage() throws InterruptedException {
		clear(CallCentre_Locators.UserManagementPageUsername);
