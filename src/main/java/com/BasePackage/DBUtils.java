...
//                    + "FROM MST_COL_AGENCY_ACC_ALLOCATED "
//                    + "WHERE agency_id = '2848' "
//                    + "AND org_id = 5";
        			
        	


			String query1="DELETE FROM MST_COL_AGENCY_ACC_ALLOCATED";
        	executeSQLStatement(query1);
        	String query2="DELETE FROM MST_COL_AGENCY_ACC_ALLOCATED_HISTORY";
        	executeSQLStatement(query2);
//        	int num=0;
//        	String query="select COLLECTION_AGENCY_ID from mst_collection_agency\r\n"
//        			+ "where collection_agency_name='KERALA'";
//        	 String str = DBUtils.executeSQLStatement(query);
// 
//        	
...
//  		  List<Object> results =
//  		  ExecuteAnyOracleSQLStoredProcedure("SP_GET_AccountCountAndOutstandingAmountOfAllocatedCollectionAgency", inputParams,
//  		  outputTypes); 
