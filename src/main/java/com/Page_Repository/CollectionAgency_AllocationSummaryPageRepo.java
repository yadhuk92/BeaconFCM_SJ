...
public class CollectionAgency_AllocationSummaryPageRepo {
	...
	public static By downloadButton = By.xpath("//i[@class = 'rzi d-inline-flex justify-content-center align-items-center']");
	...
	public static By typesOfAccountDropdown = By.xpath("//li[@aria-label='>Not Allocated']");
	...
	public static By smaCategory = By.xpath("//li[contains(@aria-label,'SMA 1 (31-60 Days)')]");
	public static By smaCategory2 = By.xpath("//li[@aria-label='SMA 2 (61-90 Days)']");
	public static By npaCategoryDropdown = By.xpath("/html/body/div[1]/div[2]/div[1]/div[2]/div[2]/div/form/div/div/div/div[4]/div/div");
	public static By npaCategory = By.xpath("//li[@aria-label='DOUBTFUL-2']//div[@class='rz-chkbox ']//div[1]");
	...
	public static By selectOperatorValue = By.xpath("(//li[@aria-label='><='])[3]");
	...
	public static By allocate = By.xpath("//button[contains(text(), 'Allocate')]");
