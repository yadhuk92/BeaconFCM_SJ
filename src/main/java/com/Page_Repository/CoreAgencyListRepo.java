...
//	
	...
	public static By Zone =By.xpath("//*[contains(text(),'Zone/CO')]/..//input");
	public static By Region =By.xpath("//*[contains(text(),'Region')]/..//input");
	...
	public static By ActivateDeactvate =By.xpath("//ul[@class='dropdown-menu show']/..//*[contains(text(),'Activate/De-activate')]");
	public static By ResetPassword =By.xpath("//ul[@class='dropdown-menu show']/..//*[contains(text(),'Reset Password')]");
	...
	public static By DateEmpanelment =By.xpath("//*[contains(text(),'Date of Empanelment')]/..//input[@placeholder='DD-MM-YYYY']");
	public static By DateEmpanelmentExpiry=By.xpath("//*[contains(text(),'Date of Empanelment Expiry')]/..//input[@placeholder='DD-MM-YYYY']");
	public static By DateStarting=By.xpath("//*[contains(text(),'Agreement Duration Starting')]/..//input[@placeholder='DD-MM-YYYY']");
	public static By DateEnding=By.xpath("//*[contains(text(),'Agreement Duration Ending')]/..//input[@placeholder='DD-MM-YYYY']");
