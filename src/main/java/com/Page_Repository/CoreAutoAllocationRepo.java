...
public class CoreAutoAllocationRepo {
	...
	public static By selectText = By
			.xpath("//*[contains(text(),'Asset Category')]/following-sibling::div//*[text()='Select']");
	...
	public static By NPADropdownCheck = By
			.xpath("//li[@aria-label='NPA Category']//div/span[contains(@class,rz-check-box)]");
	public static By SMADropdownCheck = By
			.xpath("//li[@aria-label='SMA Category']//div/span[contains(@class,rz-check-box)]");

	public static By smaCategoryDropdown = By
			.xpath("//*[contains(text(),'SMA Category')]/following-sibling::div//*[text()='Select']");
	public static By smaCategoryListBox = By.xpath("//div[@id='popup-PFTNPADisable']/following-sibling::div[1]//ul");
	public static By selectSMA0Option = By
			.xpath("//li[@aria-label='SMA 0 (01-30 Days)']//div[@class='rz-chkbox-box   ']");
	public static By selectSMA1Option = By
			.xpath("//li[@aria-label='SMA 1 (31-60 Days)']//div[@class='rz-chkbox-box   ']");
	public static By selectSMA2Option = By
			.xpath("//li[@aria-label='SMA 2 (61-90 Days)']//div[@class='rz-chkbox-box   ']");

	public static By SM0DropdownCheck = By
			.xpath("//li[@aria-label='SMA 0 (01-30 Days)']//div/span[contains(@class,rz-chkbox-icon)]");
	public static By SM1DropdownCheck = By
			.xpath("//li[@aria-label='SMA 1 (31-60 Days)']//div/span[contains(@class,rz-chkbox-icon)]");
	public static By SM2DropdownCheck = By
			.xpath("//li[@aria-label='SMA 2 (61-90 Days)']//div/span[contains(@class,rz-chkbox-icon)]");

	public static By npaCategoryDropdown = By
			.xpath("//*[contains(text(),'NPA Category')]/following-sibling::div//*[text()='Select']");
	public static By npaCategorylistDropdown = By
			.xpath("//div[@id='popup-PFTNPADisable']/following-sibling::div//li[@aria-label='SUB-STANDARD']/parent::ul/li");
	public static By npaCategorylistCheckbox = By
			.xpath("//div[@id='popup-PFTNPADisable']/following-sibling::div//li[@aria-label='SUB-STANDARD']/parent::ul/li/div//span");
	public static By npaSelectAllCheckbox = By
			.xpath("//div[@id='popup-PFTNPADisable']/following-sibling::div//li[@aria-label='SUB-STANDARD']/parent::ul/parent::div/preceding-sibling::div/div[1]");

	
	public static By OSBalanceDropdown = By
			.xpath("//*[contains(text(),'O/S Balance')]/following-sibling::div//*[text()='Select']");
	
	public static By selectEqualsOption = By
			.xpath("//div[@id='popup-PFTNPADisable']/following-sibling::div//li[@aria-label='>=']");
	...
	public static By assetCategoryDropdown = By.xpath(
			"(//label[contains(text(),'Asset Category')]//following::div[@onmousedown='Radzen.activeElement = null'])[1]");
	...
	public static By smaCategory = By.xpath(
			"(//label[contains(text(),'SMA Category')]//following::div[@onmousedown='Radzen.activeElement = null'])[1]");
	...
	public static By processingInterval = By.xpath(
			"(//label[contains(text(),'Processing Interval')]//following::div[@onmousedown='Radzen.activeElement = null'])[1]");
	...
	public static By to = By
			.xpath("(//label[contains(text(),'To')]//following::div[@onmousedown='Radzen.activeElement = null'])[8]");
	...
	public static By OutstandingBalLimitOperatordropdown = By
			.xpath("(//div[@onmousedown='Radzen.activeElement = null'])[16]");

	public static By OutstandingBalLimitOperatordropdownvalue(String value) {
		return By.xpath("(//li[@aria-label='>" + value + "'])[3]");
	}

	public static By OutstandingBalLimit = By
			.xpath("//input[@onkeypress='DecimalWithHyphen(event, this); NumberWithMaxLengthWithHyphen(event, this)']");
