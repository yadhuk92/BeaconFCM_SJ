...
//new update
public class CallCenterRoleManagementPage_MainClass extends Base_Class {
	...
	public void VerifyTheText() throws IOException {
		try {
			...
			String CoreUserName = CallCenterRoleManagementPage_MainClass.configloader().getProperty("CallcentreUserName");
...
//				driver.findElement(CallCenterRoleManagementRepo.closeRolePermissionPopup).click();
	...
	public void LogintoCallCenter() throws IOException, InterruptedException {
		String CallcentreUserName = MyDeskDashboardPage_MainClass.configloader1().getProperty("CallcentreUserName").trim();
		String CallcentreUserPassword = MyDeskDashboardPage_MainClass.configloader1().getProperty("CallcentreUserPassword")
				.trim();
