...
//Constructor
public class LoginBannerConfiguration_MainClass extends Base_Class{
	LoginBannerConfiguratonPageRepo Page_Repository=new LoginBannerConfiguratonPageRepo();
    private static WebDriver driver;
   
   public LoginBannerConfiguration_MainClass(WebDriver driver) {
    	LoginBannerConfiguration_MainClass.driver=driver;
